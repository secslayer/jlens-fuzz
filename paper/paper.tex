...
\author{Muhammed Muiz Arummal}
\date{DRAFT --- pre-arXiv --- Gate 7 signed off 2026-08-08\thanks{Not yet posted or tagged;
  disclosure to MSRC/Alibaba (\cref{sec:ethics}) is planned for posting time, not yet sent. See
...
(\texttt{configs/exp.yaml}, \texttt{configs/exp\_phi4mini.yaml}).
